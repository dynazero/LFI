...
$(document).ready(function(e) {
	...
	location.replace('galleryA.php');
	
	});
	
	$("#blog2").click(function(){
	
	location.replace('galleryB.php');
	
	});
	
	$("#blog3").click(function(){
	
	location.replace('galleryC.php');
	
	});
	
	$("#blog4").click(function(){
	
	location.replace('galleryD.php');
	
	});
	
	$("#blog5").click(function(){
	
	location.replace('galleryE.php');
	
	});
	
	$("#blog6").click(function(){
	
	location.replace('galleryF.php');
	
	});
	
	$("#blog7").click(function(){
	
	location.replace('galleryG.php');
...
<body>
        <div id="ovrallWrap">
                    ...
                    <div id="photoGall" class="carousel slide" data-ride="carousel">
                    	<?php include "carouselA.php";?>  
                                          
                    </div><!--/#photoGall-->
                    
                    <div id="articlesArea" class="rtcleSect row" >              
						<?php include "articleA.php";?>                           
                    </div><!--/.rtcleSect row-->
                     
                    <div id="blogArea">
                         <?php include "carouselB.php";?>               
                    </div><!--/#blogArea-->
                    
                    
                    <div  id="mapArea">
                           <?php include "mainMap.php";?>   
                    </div><!--/#mapArea-->
              ...
              <div id="passReset"  class="modal fade">
                         <?php include "AdminFunction/PasswordReset.php";?>         
                   </div><!-- /#loginPanel .modal -->
</body>
</html>
