...
$projectID = $_POST['pId'];
	...
	mysqli_query($con,"UPDATE `users` SET `Activated`= 3, `Role`= 3 WHERE `usersID` = $userID");
    mysqli_query($con,"UPDATE `project` SET `Activated`= 3 `View`= 2 WHERE `userID` = $projectID");
