...
<h2><!--<a data-toggle="modal" data-target="#hBlogAdd"><span class="glyphicon glyphicon-plus-sign"></span></a></span>--><a data-toggle="modal" data-target="#cGallAdd"><span class="glyphicon glyphicon-plus-sign"></span></a><?php $result = mysqli_query($con,"SELECT `Title` FROM `homeblog` WHERE `ID` = 7"); 
    ...
    <div id="gallArc" class="carousel slide" data-ride="carousel">
             ...
             <div class="carousel-inner">        
                   ...
                   <div class='item active'> 
                     ...
                     <?php $result = mysqli_query($con,"SELECT * FROM `galleryarchive` WHERE `GalleryNumber` = 7 ORDER BY ID ASC");   ?>
...
<?php include('adminFadeCustGallG.php') ?> 
</body>
