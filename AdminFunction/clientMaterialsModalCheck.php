...
</html>    <?php include("../Connections/local.php"); ?>
	
	<?php $resultProjects=mysqli_query($con,"SELECT `project`.projectID, `project`.ProjectName FROM `project` WHERE  `userID` = $usersID"); 
