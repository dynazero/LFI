	...
	/* $(".selectionClass7").click(function(){
	 ...
	 $(".selectionClass13").click(function(){
		...
		$(".selectionClass14").click(function(){
		 ...
		 $(".selectionClass16").click(function(){
		 $(".mainMenu1").hide();
		 $(".mainMenu2").hide();
		 $(".mainMenu3").hide();
		 $(".mainMenu4").hide();
...
$(".trialoA").hover(function(){
	...
	$(".panel-body").mouseover(function(){
		...
		$(this).parent().children(".pgBadge,.drBadge,.cdBadge").css({"display":"none"});
		
		});
		
	$("a").click(function(){
	
	$(this).children(".completepView").css({"display":"none"});
...
$("#projectbtnA").click(function(){
	CloseMe(1,0,0,0);
	});
	
$("#projectbtnB").click(function(){
	CloseMe(0,1,0,0);
	});
	
$("#projectbtnC").click(function(){
	CloseMe(0,0,1,0);
	});
	
$("#projectbtnD").click(function(){
	CloseMe(0,0,0,1);
	});	
	
});

function CloseMe(pbtn1, pbtn2, pbtn3, pbtn4){
		if(pbtn1 == 1){
			$("#projectPageA").show();
			}else{
				$("#projectPageA").hide();
...
function pictureSpecify(pictureID,UserRole){
	
	var formData = pictureID;
	var RoleData = UserRole;
	
	$.post("phpscripts/Parse_ViewHoverImage.php",{MyData:formData,MyRole:UserRole},function(result){
...
function pictureSpecifyclk(pictureID,UserRole){
	
	var formData = pictureID;
	var RoleData = UserRole;
	
	$.post("phpscripts/Parse_ViewClickImage.php",{MyData:formData,MyRole:UserRole},function(result){
...
function docSpecify(pictureID,UserRole){
	
	var formData = pictureID;
	var RoleData = UserRole;
	
	$.post("phpscripts/Parse_ViewDoc.php",{MyData:formData,MyRole:UserRole},function(result){
...
function cadSpecify(pictureID,UserRole){
	
	var formData = pictureID;
	var RoleData = UserRole;
	
	$.post("phpscripts/Parse_ViewCad.php",{MyData:formData,MyRole:UserRole},function(result){
	   ...
	   <div id="adminNav">
		<div class="headWrapper"> 
          ...
          <div class="greetings">Welcome <span><?php echo $loginName; ?></span></div>
        	<input type="hidden" name="checksession" id="checksession" value="<?php echo $userID; ?>" />
...
$rowA1 = mysqli_query($con,"SELECT COUNT(*) FROM `projectgallery` LEFT JOIN `commentgallery` ON `commentgallery`.projectgalleryID =`projectgallery`.projectgalleryID WHERE `commentgallery`.admin = 0 OR `projectgallery`.admin = 0");
	 ...
	 $rowA2=mysqli_query($con,"SELECT COUNT(*) FROM `projectfiles` WHERE `projectfiles`.$RoleName = 0");
					...
					if($projectView != 0){
						...
						$adminHomeBadge = "<span class='badge homeView'>!</span>";
...
?>
            ...
            <li><a class="selectionClass1" href="#"><img class="sidebarLogos" src="../Images/myFolder/homerRES.png" style="width:50px; height:50px;"/><span class="titleHolder"> Home </span><?php echo $adminHomeBadge; ?> </a> </li>
         ...
         <?php  $resultProjA = mysqli_query($con,"SELECT * FROM `project` JOIN `users` ON `project`.userID = `users`.usersID WHERE `project`.Activated = 0 AND `users`.Activated = 0 AND `project`.View = 0");
		  ...
		  if($rowProjA != 0){
			  ...
			  $newUserPropasl = "style=color:red;";
		  ...
		  if($rowProjTotal != 0){
			...
			$rowProjBadgeCode = "<span class='badge projectView'>!</span>";
		   ...
		   ?>
            ...
            <ul id="projectList" class="innerList">
            	...
            	<li><a class="selectionClass5" <?php echo $newUserPropasl; ?>>New User Project Proposal</a></li>
                <li><a class="selectionClass6" <?php echo $newPropasl; ?>>New Project Proposal</a></li>
                <li><a class="selectionClass7" href="GenerateReportsProjects.php" target="new">Generate Reports</a></li>
            </ul>
            ...
            <li class="inventory"><a  href="#"><img class="sidebarLogos" src="../Images/myFolder/reportsRES.png" style="width:50px; height:50px;"/><span class="titleHolder">Inventory</span></a>  
             <ul id="inventoryList" class="innerList">
                ...
                <li><a class="selectionClass7" href="GenerateReportsMaterials.php" target="new">Generate Reports</a></li>
            </ul>
          </li>
            ...
            <li class="usersAcct"><a href="#"><img class="sidebarLogos" src="../Images/myFolder/avatarRES.png" style="width:50px; height:50px;"/><span class="titleHolder">Users Acct.</span></a>          
             <ul id="useracctList" class="innerList">
                ...
                <li><a class="selectionClass16">Edit Profile</a></li> 
                </ul>
...
?>  
                   ...
                   <li><a class="selectionClass2" href="#"><img class="sidebarLogos" src="../Images/myFolder/leaveManagementRES.png" style="width:50px; height:50px;"/><span class="titleHolder">My Projects</span></a> </li>	
                   
                    <li class="projects"><a  href="#"><img class="sidebarLogos" src="../Images/myFolder/reportsRES.png" style="width:50px; height:50px;"/><span class="titleHolder">Inventory</span></a> 
            
            <ul id="projectList" class="innerList">
            	
                <li><a class="selectionClass3">Materials Add</a></li>
                <li><a class="selectionClass4">My Storage</a></li>
            	<li><a class="selectionClass5">Materials Logs</a></li>
                
            </ul>
         
         </li>	
         
         <li><a class="selectionClass6" href="#"><img class="sidebarLogos" src="../Images/myFolder/avatarRES.png" style="width:50px; height:50px;"/><span class="titleHolder">Edit Profile</span></a> </li>   
                ...
                <!--End of Project Manager Selection Class-->
                  ...
                  <?php  $RoleName = "client";
                   ...
                   <li><a class="selectionClass2" href="#"><img class="sidebarLogos" src="../Images/myFolder/leaveManagementRES.png" style="width:50px; height:50px;"/><span class="titleHolder">My Projects</span></a> </li>	
                    ...
                    <li><a class="selectionClass3" href="#"><img class="sidebarLogos" src="../Images/myFolder/buildingLogo.png" style="width:50px; height:50px;"/><span class="titleHolder">Send Proposal</span></a> </li>
                    
                    <li><a class="selectionClass4" href="#"><img class="sidebarLogos" src="../Images/myFolder/avatarRES.png" style="width:50px; height:50px;"/><span class="titleHolder">Edit Profile</span></a> </li> 
		...
		<?php	}else if($Role == 3){ ?>
			...
			<?php include('clientPageMenu.php');?>      
			</div>                  
