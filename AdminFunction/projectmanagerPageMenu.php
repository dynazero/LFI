...
function startViewRefresh(){
		setInterval(function(){
			...
			$.post("phpscripts/Parse_ViewHomeCheckerB.php",{myuser:userID},function(result){
				...
				<div class="mainMenu1 menuClass"><?php include('projectmanagerProjectAdmin.php');?></div>
                <div class="mainMenu2 menuClass"><?php include('projectmanagerMyProjects.php');?></div>
                          
                <div class="mainMenu3 menuClass"><?php include('projectmanagerMaterialsAdd.php');?></div>
                
                <div class="mainMenu4 menuClass"><?php include('adminMyMaterials.php');?></div>
                
                <div class="mainMenu5 menuClass"><?php include('projectmanagerMaterialsLogs.php');?></div>
                <div class="mainMenu6 menuClass"><?php include('PersonalInfo.php');?></div>          
