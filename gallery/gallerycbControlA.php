...
<?php $result = mysqli_query($con,"SELECT * FROM galleryarchive WHERE GalleryNumber ='1'");
				  		$x = 0;
						while($row=mysqli_fetch_array($result)){
						?>
<div class="item">
<a rel="clearbox[gallery=Gallery,,comment=<?php echo $row['Description'];?>]" href="../<?php echo $row['PathFile'];?>" title="<?php echo $row['Title'];?>">
<img class="border"src="../<?php echo $row['PathFile'];?>" alt="<?php echo $row['Title'];?>" /></a></div>       
                         <?php $x++; }?>
