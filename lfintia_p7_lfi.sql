...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2015 at 05:36 AM
...
INSERT INTO `commentgallery` (`projectgalleryID`, `commentID`, `comment`, `usersID`, `date`, `Activated`) VALUES
(1, 1, 'asdfasfd', 1, '2014-12-18 05:11:07', 1),
(1, 2, 'Testing Comment', 2, '2015-01-06 04:36:10', 0),
(1, 3, 'This is a comment', 2, '2015-01-07 19:08:06', 0),
(1, 4, 'Alots of comment', 2, '2015-01-07 19:08:24', 0),
(5, 6, 'Test Comment', 3, '2015-01-31 03:25:19', 0);
...
(1, 'THIS IS LFI ADDRESS.com', '5555555', '0905741852963', 'Lfi.local@gmail.com', 'https://www.facebook.com/    ');
...
(10, 1, 3, 'HuhuProject', 2, 1, '../ProfilePic/Penguins.jpg', 0, '', 'ETO PO ANG SCALe'),
...
(43, 2, 33, '#journeytomarsNASA.pdf', 0, 0, '', 0, NULL, NULL),
(44, 2, 34, '112_Receipt_4_FairyClean_HK_2013.pdf', 0, 0, '', 0, NULL, NULL),
...
(50, 1, 1, 'This is my ProjectArch', 0, 1, '../ProfilePic/mario bros..PNG', 0, NULL, NULL),
(51, 2, 1, 'My Own Project', 0, 2, '../ProfilePic/10882246_982822015078992_8271693759579988532_n.jpg', 0, NULL, NULL),
(52, 2, 29, 'Myles', 1, 1, '../ProfilePic/Royal Maids logo.pdf', 0, 'this is Employee', NULL),
(53, 1, 3, 'Testing Proposal No. 1', 1, 1, '../ProfilePic/Tekken neutral game guide full finished v1.0.pdf', 0, '', NULL);
...
INSERT INTO `projectfiles` (`projectFilesID`, `userID`, `pathfile`, `projectID`) VALUES
(12, 2, '../proposalPDF/6-CO-HK-VIRTUAL-OFFICES.pdf', 10),
(13, 3, '../proposalPDF/6-CO-HK-VIRTUAL-OFFICES.pdf', 11),
(23, 29, '../proposalPDF/Wohnsitzbestatigung_Razel.pdf', 40),
(24, 30, '../proposalPDF/#journeytomarsNASA.pdf', 41),
(25, 31, '../proposalPDF/#journeytomarsNASA.pdf', 42),
(26, 33, '../proposalPDF/#journeytomarsNASA.pdf', 1),
(27, 34, '../proposalPDF/112_Receipt_4_FairyClean_HK_2013.pdf', 1),
(28, 35, '../proposalPDF/6-CO-HK-VIRTUAL-OFFICES.pdf', 1),
(29, 36, '../proposalPDF/Bonus_5_Types_Of_Orgasms.pdf', 1),
(30, 37, '../proposalPDF/#journeytomarsNASA.pdf', 1);
...
(1, 10, 'bbd4b7db6bfc4bf099174b9d9386764a.jpeg', 'projectGallery/bbd4b7db6bfc4bf099174b9d9386764a.jpeg', 0),
